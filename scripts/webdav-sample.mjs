// Stands up a throwaway WebDAV server over `content-sample/` using rclone,
...
//
// Usage:  node scripts/webdav-sample.mjs [dir] [port]
// Ctrl-C to stop.
...
const dir = path.resolve(process.argv[2] ?? path.join(__dirname, "..", "content-sample"));
